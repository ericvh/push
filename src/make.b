...
Cmd, Env, Item, Stab:	import pushlib;
Depend, Rule, Target:	import pushlib;
sys, bufio, hash:		import pushlib;
...
explicit(e: ref Env, t: ref Target, n: ref Node): int
{
	...
	if (d != nil) {
		if (n.state == SNoexist || n.state == SStale) {
			...
			e = e.copy();
			e.flags |= pushlib->EEcho | Pushlib->ERaise;
...
{
	for (l := pushlib->rules; l != nil; l = tl l)
		prrule(out, hd l);
}

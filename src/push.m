...
Pushlib: module
{
	...
	Stab: adt
	{
		...
		defbuiltin:	fn(t: self ref Stab, s: string, b: Pushbuiltin);
		...
		update:		fn(t: self ref Stab, s: string, tag: int, v: list of string, f: ref Cmd, b: Pushbuiltin): ref Symb;
	};

	ETop, EInter, EEcho, ERaise, EDumping, ENoxeq, ENodist, Emktree, EPdebug:
		con 1 << iota;
	...
	Env: adt
	{
		...
		flags:		int;
		in, out:	ref Sys->FD;
		# this is a kludge, to be replaced with a better version later
		mp: array of array of ref Sys->FD;
		npipe: int;
		stderr:		ref Sys->FD;
		wait:		ref Sys->FD;
		file:		ref File;
		...
		builtin:	fn(e: self ref Env, s: string): Pushbuiltin;
		defbuiltin:	fn(e: self ref Env, s: string, b: Pushbuiltin);
		...
		multipipe:	fn(e: self ref Env, n: int): array of array of ref Sys->FD;
		...
		lex:		fn(e: self ref Env, y: ref Pushparse->YYSTYPE): int;
		mklist:		fn(e: self ref Env, l: list of ref Item): list of ref Item;
		mksimple:	fn(e: self ref Env, l: list of ref Item): ref Cmd;
	};

	initpush:	fn(ctxt: ref Draw->Context, top: ref Tk->Toplevel, s: Sys, e: ref Env, l: Pushlib, p: Pushparse);
	...
	HISTF:		con "history";
	LIB:		con "/dis/lib/push/";
	PUSHF:		con "push";
	PUSHINIT:	con "pushinit";
	PROFILE:	con "/lib/pushinit";
	TRUE:		con "true";
	MAXELEV:	con 256;
...
#
#	Interface to loadable builtin modules.  pushinit is called when a module
#	is loaded.  pushcmd is called for a builtin as defined by Env.defbuiltin().
#	init() is in the interface to catch the use of builtin modules as commands.
#	name() is used by whatis.
#
Pushbuiltin: module
{
	pushinit:	fn(l: list of string, lib: Pushlib, this: Pushbuiltin, e: ref Pushlib->Env);
	pushcmd:	fn(e: ref Pushlib->Env, l: list of string);
